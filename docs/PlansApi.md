...
namespace Example
{
    public class FindPlansExample
    {
        public void main()
        {
            ...
            var body = new RequestPlanFind(); // RequestPlanFind | 

            try
            {
                // Find Plans
                PlanSearchResponse result = apiInstance.FindPlans(body);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling PlansApi.FindPlans: " + e.Message );
            }
        }
    }
}
...
<a name="showplan"></a>
# **ShowPlan**
> PlanShowResponse ShowPlan (string id, int? year = null)
...
namespace Example
{
    public class ShowPlanExample
    {
        public void main()
        {
            ...
            {
                // Show Plan
                PlanShowResponse result = apiInstance.ShowPlan(id, year);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
