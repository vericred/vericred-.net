...
namespace IO.Vericred.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkSize :  IEquatable<NetworkSize>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkSize" /> class.
        /// </summary>
        /// <param name="NetworkId">Foreign key to Network.</param>
        /// <param name="Count">Number of Providers in-network in this State.</param>
        /// <param name="StateId">Foreign key to State.</param>
        public NetworkSize(int? NetworkId = null, int? Count = null, string StateId = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NetworkSize);
        }

        /// <summary>
        /// Returns true if NetworkSize instances are equal
        /// </summary>
        /// <param name="other">Instance of NetworkSize to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkSize other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
