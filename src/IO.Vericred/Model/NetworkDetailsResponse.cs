...
namespace IO.Vericred.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NetworkDetailsResponse :  IEquatable<NetworkDetailsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NetworkDetailsResponse" /> class.
        /// </summary>
        /// <param name="Network">Network details.</param>
        public NetworkDetailsResponse(NetworkDetails Network = null)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NetworkDetailsResponse);
        }

        /// <summary>
        /// Returns true if NetworkDetailsResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of NetworkDetailsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NetworkDetailsResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
