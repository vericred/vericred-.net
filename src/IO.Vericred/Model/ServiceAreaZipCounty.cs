...
namespace IO.Vericred.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ServiceAreaZipCounty :  IEquatable<ServiceAreaZipCounty>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ServiceAreaZipCounty" /> class.
        /// </summary>
        /// <param name="CountyId">Foreign key to county.</param>
        /// <param name="ServiceAreaId">Foreign key to service area.</param>
        /// <param name="ZipCodeId">Foreign key to zip code.</param>
        public ServiceAreaZipCounty(string CountyId = null, string ServiceAreaId = null, string ZipCodeId = null)
        {
        ...
        /// </summary>
        /// <value>Foreign key to service area</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ServiceAreaZipCounty);
        }

        /// <summary>
        /// Returns true if ServiceAreaZipCounty instances are equal
        /// </summary>
        /// <param name="other">Instance of ServiceAreaZipCounty to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ServiceAreaZipCounty other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
