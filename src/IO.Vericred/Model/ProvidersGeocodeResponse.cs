...
namespace IO.Vericred.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProvidersGeocodeResponse :  IEquatable<ProvidersGeocodeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProvidersGeocodeResponse" /> class.
        /// </summary>
        /// <param name="Meta">Meta-data.</param>
        /// <param name="Providers">Providers that fit the requested criterion..</param>
        public ProvidersGeocodeResponse(Meta Meta = null, List<Provider> Providers = null)
        {
            this.Meta = Meta;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProvidersGeocodeResponse);
        }

        /// <summary>
        /// Returns true if ProvidersGeocodeResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ProvidersGeocodeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProvidersGeocodeResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
