...
namespace IO.Vericred.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StateNetworkSizeRequest :  IEquatable<StateNetworkSizeRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateNetworkSizeRequest" /> class.
        /// </summary>
        /// <param name="NetworkIds">List of Network Ids.</param>
        /// <param name="StateIds">List of State Ids.</param>
        public StateNetworkSizeRequest(List<int?> NetworkIds = null, List<string> StateIds = null)
        {
        ...
        /// List of Network Ids
        /// </summary>
        /// <value>List of Network Ids</value>
        [DataMember(Name="network_ids", EmitDefaultValue=false)]
        public List<int?> NetworkIds { get; set; }
        /// <summary>
        /// List of State Ids
        /// </summary>
        /// <value>List of State Ids</value>
        [DataMember(Name="state_ids", EmitDefaultValue=false)]
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as StateNetworkSizeRequest);
        }

        /// <summary>
        /// Returns true if StateNetworkSizeRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of StateNetworkSizeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StateNetworkSizeRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.StateIds == other.StateIds ||
                    this.StateIds != null &&
                    this.StateIds.SequenceEqual(other.StateIds)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.StateIds != null)
                    hash = hash * 59 + this.StateIds.GetHashCode();
                return hash;
            }
        }
    }
