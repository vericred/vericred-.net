...
namespace IO.Vericred.Api
{
    ...
    /// </summary>
    public interface IDrugCoveragesApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class DrugCoveragesApi : IDrugCoveragesApi
    {
        private IO.Vericred.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="DrugCoveragesApi"/> class.
        /// </summary>
        /// <returns></returns>
        public DrugCoveragesApi(String basePath)
        {
        ...
        /// <returns></returns>
        public DrugCoveragesApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< DrugCoverageResponse > GetDrugCoveragesWithHttpInfo (string ndcPackageCode, string audience, string stateCode)
        {
            ...
            if (ndcPackageCode == null)
                throw new ApiException(400, "Missing required parameter 'ndcPackageCode' when calling DrugCoveragesApi->GetDrugCoverages");
            // verify the required parameter 'audience' is set
            if (audience == null)
                throw new ApiException(400, "Missing required parameter 'audience' when calling DrugCoveragesApi->GetDrugCoverages");
            // verify the required parameter 'stateCode' is set
            if (stateCode == null)
                throw new ApiException(400, "Missing required parameter 'stateCode' when calling DrugCoveragesApi->GetDrugCoverages");
