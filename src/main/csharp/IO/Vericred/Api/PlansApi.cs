...
namespace IO.Vericred.Api
{
    ...
    public interface IPlansApi
    {
        ...
        /// <param name="query">Plan query</param>
        ...
        ApiResponse<List<Plan>> PlansFindPostWithHttpInfo (Query query);
        ...
        System.Threading.Tasks.Task<List<Plan>> PlansFindPostAsync (Query query);
        ...
        System.Threading.Tasks.Task<ApiResponse<List<Plan>>> PlansFindPostAsyncWithHttpInfo (Query query);
    ...
    public class PlansApi : IPlansApi
    {
        ...
        /// <param name="query">Plan query</param>
        /// <returns>List&lt;Plan&gt;</returns>
        public List<Plan> PlansFindPost (Query query)
        {
             ApiResponse<List<Plan>> localVarResponse = PlansFindPostWithHttpInfo(query);
        ...
        /// <param name="query">Plan query</param>
        /// <returns>ApiResponse of List&lt;Plan&gt;</returns>
        public ApiResponse< List<Plan> > PlansFindPostWithHttpInfo (Query query)
        {
            // verify the required parameter 'query' is set
            if (query == null)
                throw new ApiException(400, "Missing required parameter 'query' when calling PlansApi->PlansFindPost");

            var localVarPath = "/plans/find";
            ...
            if (localVarStatusCode >= 400)
                throw new ApiException (localVarStatusCode, "Error calling PlansFindPost: " + localVarResponse.Content, localVarResponse.Content);
            else if (localVarStatusCode == 0)
                throw new ApiException (localVarStatusCode, "Error calling PlansFindPost: " + localVarResponse.ErrorMessage, localVarResponse.ErrorMessage);
        ...
        /// <param name="query">Plan query</param>
        /// <returns>Task of List&lt;Plan&gt;</returns>
        public async System.Threading.Tasks.Task<List<Plan>> PlansFindPostAsync (Query query)
        {
             ApiResponse<List<Plan>> localVarResponse = await PlansFindPostAsyncWithHttpInfo(query);
             return localVarResponse.Data;
        ...
        /// <param name="query">Plan query</param>
        /// <returns>Task of ApiResponse (List&lt;Plan&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Plan>>> PlansFindPostAsyncWithHttpInfo (Query query)
        {
            // verify the required parameter 'query' is set
            if (query == null)
                throw new ApiException(400, "Missing required parameter 'query' when calling PlansApi->PlansFindPost");
